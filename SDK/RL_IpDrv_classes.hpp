...
{
public:
	struct FScriptDelegate                             __EventAdHocOnNetworkChanged__Delegate;                   // 0x0060(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0060(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __EventAdHocError__Delegate;                              // 0x0078(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0078(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __EventAdHocInitialized__Delegate;                        // 0x0090(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0090(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __EventAccessPointCreated__Delegate;                      // 0x00A8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData03[0x8];                                       // 0x00A8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __EventBecomeStation__Delegate;                           // 0x00C0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData04[0x8];                                       // 0x00C0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __EventStationConnected__Delegate;                        // 0x00D8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData05[0x8];                                       // 0x00D8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __EventStationDisconnected__Delegate;                     // 0x00F0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData06[0x8];                                       // 0x00F0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __EventAdHocFinalized__Delegate;                          // 0x0108(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData07[0x8];                                       // 0x0108(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __EventAdHocDestroyed__Delegate;                          // 0x0120(0x0010) (NeedCtorLink)
...
public:
	...
	TEnumAsByte<EAvatarSize>                           AvatarSize;                                               // 0x00A8(0x0001)
	unsigned char                                      UnknownData00[0x7];                                       // 0x00A9(0x0007) MISSED OFFSET
	class UTexture*                                    Texture;                                                  // 0x00B0(0x0008)
	struct FScriptDelegate                             Callbacks;                                                // 0x00B8(0x0010) (NeedCtorLink)
...
{
public:
	struct FPointer                                    VoiceEngine;                                              // 0x02E0(0x0008) (Const, Native, Transient)
	int                                                MaxLocalTalkers;                                          // 0x02E8(0x0004) (Config)
	int                                                MaxRemoteTalkers;                                         // 0x02EC(0x0004) (Config)
	unsigned long                                      bIsUsingSpeechRecognition : 1;                            // 0x02F0(0x0004) (Config)
	unsigned char                                      UnknownData00[0x4];                                       // 0x02F4(0x0004) MISSED OFFSET
	class UOnlineGameInterfaceImpl*                    GameInterfaceImpl;                                        // 0x02F8(0x0008)
	class UOnlineAuthInterfaceImpl*                    AuthInterfaceImpl;                                        // 0x0300(0x0008)
	class UOnlinePurchaseInterfaceImpl*                PurchaseInterfaceImpl;                                    // 0x0308(0x0008)
	struct FScriptDelegate                             __OnSanitizeStringComplete__Delegate;                     // 0x0310(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0310(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnPlayerCountryRetrieved__Delegate;                     // 0x0328(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0328(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	int                                                PendingDownloadCount;                                     // 0x00D0(0x0004) (Native)
	int                                                ActiveDownloadCount;                                      // 0x00D4(0x0004) (Native)
	int                                                SucceededDownloadCount;                                   // 0x00D8(0x0004) (Native)
	int                                                FailedDownloadCount;                                      // 0x00DC(0x0004) (Native)
	struct FScriptDelegate                             __OnOnlineImageFinished__Delegate;                        // 0x00E0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x8];                                       // 0x00E0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __EventImageDecoded__Delegate;                            // 0x00F8(0x0010) (NeedCtorLink)
	...
	TEnumAsByte<EImageType> STATIC_GetImageType(const struct FString& ContentType);
	...
	void RequestOnlineImages(const struct FScriptDelegate& FinishedCallback, bool bSupportSRGB, TArray<struct FString>* URLs);
...
{
public:
	class UAvatarDownloadMap*                          AvatarDownloadCache;                                      // 0x0070(0x0008) (ExportObject, Component, EditInline)
	...
	class UAvatarDownload* GetAvatar(const struct FUniqueNetId& PlayerID, TEnumAsByte<EAvatarSize> Size);
	void ClearPendingDownloads();
	void CleanupAvatars();
	void DownloadAvatar(const struct FUniqueNetId& PlayerID, TEnumAsByte<EAvatarSize> Size, const struct FString& URL);
	void StoreNewAvatars(TEnumAsByte<EAvatarSize> Size, const struct FScriptDelegate& ReadOnlineAvatarCompleteDelegate, TArray<struct FUniqueNetId>* NewPlayerIDs);
	void ProcessOldRequests(TEnumAsByte<EAvatarSize> SizeType, const struct FScriptDelegate& ReadOnlineAvatarCompleteDelegate, TArray<struct FUniqueNetId>* InPlayerIDs, TArray<struct FUniqueNetId>* NewRequestIDs);
	bool TryAddAvatarTextureCallback(const struct FUniqueNetId& PlayerNetId, TEnumAsByte<EAvatarSize> Size, const struct FScriptDelegate& ReadOnlineAvatarCompleteDelegate);
};
...
public:
	...
	unsigned long                                      MaxRedirection : 1;                                       // 0x0AC4(0x0004) (Config)
...
public:
	...
	struct FScriptDelegate                             __ImageDecodedDelegate__Delegate;                         // 0x0078(0x0010) (NeedCtorLink)
	...
	void RequestDecodeImage(const struct FString& RequestURL, TEnumAsByte<EImageType> ImageType, const struct FScriptDelegate& FinishedCallback, TArray<unsigned char>* ImageData);
...
{
public:
	TEnumAsByte<ELinkMode>                             LinkMode;                                                 // 0x0268(0x0001)
	TEnumAsByte<ELineMode>                             InLineMode;                                               // 0x0269(0x0001)
	TEnumAsByte<ELineMode>                             OutLineMode;                                              // 0x026A(0x0001)
	TEnumAsByte<EReceiveMode>                          ReceiveMode;                                              // 0x026B(0x0001)
...
public:
	...
	TEnumAsByte<ELinkState>                            LinkState;                                                // 0x0298(0x0001)
...
public:
	...
	struct FScriptDelegate                             __OnReadNewsCompleted__Delegate;                          // 0x00A8(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnReadTitleFileComplete__Delegate;                      // 0x00E8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x8];                                       // 0x00E8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnRequestTitleFileListComplete__Delegate;               // 0x0100(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnSaveTitleFileComplete__Delegate;                      // 0x00C8(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnCreateMessageComplete__Delegate;                      // 0x00B0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x8];                                       // 0x00B0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnDeleteMessageComplete__Delegate;                      // 0x00C8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x8];                                       // 0x00C8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnQueryMessagesComplete__Delegate;                      // 0x00E0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData03[0x8];                                       // 0x00E0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnQueryMessageContentsComplete__Delegate;               // 0x00F8(0x0010) (NeedCtorLink)
...
public:
	...
	struct FScriptDelegate                             __OnReadUserFileComplete__Delegate;                       // 0x0120(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0120(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnWriteUserFileComplete__Delegate;                      // 0x0138(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0138(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnDeleteUserFileComplete__Delegate;                     // 0x0150(0x0010) (NeedCtorLink)
...
public:
	...
	unsigned long                                      bIsInTick : 1;                                            // 0x0078(0x0004) (Transient)
	unsigned long                                      bWantsDeferredDestroy : 1;                                // 0x0078(0x0004) (Transient)
	unsigned long                                      bShouldTick : 1;                                          // 0x0078(0x0004)
...
public:
	...
	struct FClientConnectionRequest                    ClientPendingRequest;                                     // 0x00B8(0x0060) (Const, NeedCtorLink)
	struct FClientBandwidthTestData                    CurrentBandwidthTest;                                     // 0x0118(0x0014)
	TEnumAsByte<EMeshBeaconClientState>                ClientBeaconState;                                        // 0x012C(0x0001)
	TEnumAsByte<EMeshBeaconPacketType>                 ClientBeaconRequestType;                                  // 0x012D(0x0001)
	unsigned char                                      UnknownData00[0x2];                                       // 0x012E(0x0002) MISSED OFFSET
	float                                              ConnectionRequestTimeout;                                 // 0x0130(0x0004) (Config)
	float                                              ConnectionRequestElapsedTime;                             // 0x0134(0x0004)
	struct FString                                     ResolverClassName;                                        // 0x0138(0x0010) (Config, NeedCtorLink)
	class UClass*                                      ResolverClass;                                            // 0x0148(0x0008)
	class UClientBeaconAddressResolver*                Resolver;                                                 // 0x0150(0x0008)
	unsigned long                                      bUsingRegisteredAddr : 1;                                 // 0x0158(0x0004) (Transient)
	unsigned char                                      UnknownData01[0x4];                                       // 0x015C(0x0004) MISSED OFFSET
	struct FScriptDelegate                             __OnConnectionRequestResult__Delegate;                    // 0x0160(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x8];                                       // 0x015C(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnReceivedBandwidthTestRequest__Delegate;               // 0x0178(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData03[0x8];                                       // 0x0178(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnReceivedBandwidthTestResults__Delegate;               // 0x0190(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData04[0x8];                                       // 0x0190(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnTravelRequestReceived__Delegate;                      // 0x01A8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData05[0x8];                                       // 0x01A8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnCreateNewSessionRequestReceived__Delegate;            // 0x01C0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData06[0x8];                                       // 0x01C0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	struct FUniqueNetId                                OwningPlayerId;                                           // 0x00C8(0x0038) (Const)
	unsigned long                                      bAllowBandwidthTesting : 1;                               // 0x0100(0x0004)
	int                                                ConnectionBacklog;                                        // 0x0104(0x0004) (Config)
	struct FScriptDelegate                             __OnReceivedClientConnectionRequest__Delegate;            // 0x0108(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0108(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnStartedBandwidthTest__Delegate;                       // 0x0120(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0120(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnFinishedBandwidthTest__Delegate;                      // 0x0138(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0138(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnAllPendingPlayersConnected__Delegate;                 // 0x0150(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData03[0x8];                                       // 0x0150(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnReceivedClientCreateNewSessionResult__Delegate;       // 0x0168(0x0010) (NeedCtorLink)
...
public:
	...
	unsigned long                                      bAuthReady : 1;                                           // 0x0088(0x0004) (Const)
	...
	struct FScriptDelegate                             __OnAuthReady__Delegate;                                  // 0x0290(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0290(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnClientAuthRequest__Delegate;                          // 0x02A8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData03[0x8];                                       // 0x02A8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnServerAuthRequest__Delegate;                          // 0x02C0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData04[0x8];                                       // 0x02C0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnClientAuthResponse__Delegate;                         // 0x02D8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData05[0x8];                                       // 0x02D8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnServerAuthResponse__Delegate;                         // 0x02F0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData06[0x8];                                       // 0x02F0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnClientAuthComplete__Delegate;                         // 0x0308(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData07[0x8];                                       // 0x0308(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnServerAuthComplete__Delegate;                         // 0x0320(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData08[0x8];                                       // 0x0320(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnClientAuthEndSessionRequest__Delegate;                // 0x0338(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData09[0x8];                                       // 0x0338(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnServerAuthRetryRequest__Delegate;                     // 0x0350(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData10[0x8];                                       // 0x0350(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnClientConnectionClose__Delegate;                      // 0x0368(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData11[0x8];                                       // 0x0368(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnServerConnectionClose__Delegate;                      // 0x0380(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData12[0x8];                                       // 0x0380(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnReceivedAuthCode__Delegate;                           // 0x0398(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData13[0x8];                                       // 0x0398(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnAccountAuthorization__Delegate;                       // 0x03B0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData14[0x8];                                       // 0x03B0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	struct FScriptDelegate                             __OnFindOnlineGamesComplete__Delegate;                    // 0x0168(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0168(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnCreateOnlineGameComplete__Delegate;                   // 0x0180(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0180(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnUpdateOnlineGameComplete__Delegate;                   // 0x0198(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData03[0x8];                                       // 0x0198(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnDestroyOnlineGameComplete__Delegate;                  // 0x01B0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData04[0x8];                                       // 0x01B0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnCancelFindOnlineGamesComplete__Delegate;              // 0x01C8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData05[0x8];                                       // 0x01C8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnJoinOnlineGameComplete__Delegate;                     // 0x01E0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData06[0x8];                                       // 0x01E0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnRegisterPlayerComplete__Delegate;                     // 0x01F8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData07[0x8];                                       // 0x01F8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnUnregisterPlayerComplete__Delegate;                   // 0x0210(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData08[0x8];                                       // 0x0210(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnStartOnlineGameComplete__Delegate;                    // 0x0228(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData09[0x8];                                       // 0x0228(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnEndOnlineGameComplete__Delegate;                      // 0x0240(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData10[0x8];                                       // 0x0240(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnArbitrationRegistrationComplete__Delegate;            // 0x0258(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData11[0x8];                                       // 0x0258(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnGameInviteAccepted__Delegate;                         // 0x0270(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData12[0x8];                                       // 0x0270(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnRecalculateSkillRatingComplete__Delegate;             // 0x0288(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData13[0x8];                                       // 0x0288(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnMigrateOnlineGameComplete__Delegate;                  // 0x02A0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData14[0x8];                                       // 0x02A0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnJoinMigratedOnlineGameComplete__Delegate;             // 0x02B8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData15[0x8];                                       // 0x02B8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnQosStatusChanged__Delegate;                           // 0x02D0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData16[0x8];                                       // 0x02D0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __EventReportMatchmakingInfo__Delegate;                   // 0x02E8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData17[0x8];                                       // 0x02E8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnGamePlayersChanged__Delegate;                         // 0x0300(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData18[0x8];                                       // 0x0300(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	struct FScriptDelegate                             __OnCreateLobbyComplete__Delegate;                        // 0x0170(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0170(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnFindLobbiesComplete__Delegate;                        // 0x0188(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0188(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnJoinLobbyComplete__Delegate;                          // 0x01A0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x8];                                       // 0x01A0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnLobbySettingsUpdate__Delegate;                        // 0x01B8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData03[0x8];                                       // 0x01B8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnLobbyMemberSettingsUpdate__Delegate;                  // 0x01D0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData04[0x8];                                       // 0x01D0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnLobbyMemberStatusUpdate__Delegate;                    // 0x01E8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData05[0x8];                                       // 0x01E8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnLobbyReceiveMessage__Delegate;                        // 0x0200(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData06[0x8];                                       // 0x0200(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnLobbyReceiveBinaryData__Delegate;                     // 0x0218(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData07[0x8];                                       // 0x0218(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnLobbyJoinGame__Delegate;                              // 0x0230(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData08[0x8];                                       // 0x0230(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnLobbyInvite__Delegate;                                // 0x0248(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData09[0x8];                                       // 0x0248(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnLobbyDestroyed__Delegate;                             // 0x0260(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData10[0x8];                                       // 0x0260(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnLobbySessionCreated__Delegate;                        // 0x0278(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData11[0x8];                                       // 0x0278(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnLobbyError__Delegate;                                 // 0x0290(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData12[0x8];                                       // 0x0290(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnHostStartPlayTogether__Delegate;                      // 0x02A8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData13[0x8];                                       // 0x02A8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	TScriptInterface<class UOnlineTitleFileInterface>  TitleFileInterface;                                       // 0x00C0(0x0010) (Transient)
	...
	struct FScriptDelegate                             __OnReadPlaylistComplete__Delegate;                       // 0x0118(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0118(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnPlaylistPopulationDataUpdated__Delegate;              // 0x0130(0x0010) (NeedCtorLink)
...
{
public:
	struct FScriptDelegate                             __EventGetAppPriceInfoComplete__Delegate;                 // 0x0060(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0060(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnMicroTxnResponse__Delegate;                           // 0x0078(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0078(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x006C(0x0004) MISSED OFFSET
	struct FPointer                                    Socket;                                                   // 0x0070(0x0008) (Native, Transient)
	unsigned long                                      bIsInTick : 1;                                            // 0x0078(0x0004)
	unsigned long                                      bWantsDeferredDestroy : 1;                                // 0x0078(0x0004)
	unsigned long                                      bShouldTick : 1;                                          // 0x0078(0x0004)
	float                                              HeartbeatTimeout;                                         // 0x007C(0x0004) (Config)
	float                                              ElapsedHeartbeatTime;                                     // 0x0080(0x0004)
	struct FName                                       BeaconName;                                               // 0x0084(0x0008)
	unsigned char                                      UnknownData01[0x4];                                       // 0x008C(0x0004) MISSED OFFSET
	struct FScriptDelegate                             __OnDestroyComplete__Delegate;                            // 0x0090(0x0010) (NeedCtorLink)
...
public:
	struct FOnlineGameSearchResult                     HostPendingRequest;                                       // 0x00A8(0x0010) (Const)
	struct FPartyReservation                           PendingRequest;                                           // 0x00B8(0x0050) (NeedCtorLink)
	TEnumAsByte<EPartyBeaconClientState>               ClientBeaconState;                                        // 0x0108(0x0001)
	TEnumAsByte<EPartyBeaconClientRequest>             ClientBeaconRequestType;                                  // 0x0109(0x0001)
	unsigned char                                      UnknownData00[0x2];                                       // 0x010A(0x0002) MISSED OFFSET
	float                                              ReservationRequestTimeout;                                // 0x010C(0x0004) (Config)
	float                                              ReservationRequestElapsedTime;                            // 0x0110(0x0004)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0114(0x0004) MISSED OFFSET
	struct FString                                     ResolverClassName;                                        // 0x0118(0x0010) (Config, NeedCtorLink)
	class UClass*                                      ResolverClass;                                            // 0x0128(0x0008)
	class UClientBeaconAddressResolver*                Resolver;                                                 // 0x0130(0x0008)
	struct FScriptDelegate                             __OnReservationRequestComplete__Delegate;                 // 0x0138(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0138(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnReservationCountUpdated__Delegate;                    // 0x0150(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData03[0x8];                                       // 0x0150(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnTravelRequestReceived__Delegate;                      // 0x0168(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData04[0x8];                                       // 0x0168(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnHostIsReady__Delegate;                                // 0x0180(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData05[0x8];                                       // 0x0180(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnHostHasCancelled__Delegate;                           // 0x0198(0x0010) (NeedCtorLink)
...
public:
	...
	unsigned long                                      bBestFitTeamAssignment : 1;                               // 0x00EC(0x0004)
	TEnumAsByte<EPartyBeaconHostState>                 BeaconState;                                              // 0x00F0(0x0001) (Const)
	unsigned char                                      UnknownData00[0x7];                                       // 0x00F1(0x0007) MISSED OFFSET
	struct FScriptDelegate                             __OnReservationChange__Delegate;                          // 0x00F8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x8];                                       // 0x00F1(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnReservationsFull__Delegate;                           // 0x0110(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0110(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnClientCancellationReceived__Delegate;                 // 0x0128(0x0010) (NeedCtorLink)
...
// 0x0028 (0xB200 - 0xB1D8)
class UTcpipConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x28];                                      // 0xB1D8(0x0028) MISSED OFFSET
...
public:
	...
	unsigned long                                      AllowPlayerPortUnreach : 1;                               // 0x0268(0x0004) (Config)
	unsigned long                                      UnknownData01 : 63;                                       // 0x0268(0x0001)
	unsigned long                                      LogPortUnreach : 1;                                       // 0x026C(0x0004) (Config)
...
public:
	...
	TEnumAsByte<ERequestType>                          RequestType;                                              // 0x00B8(0x0001)
...
public:
	...
	unsigned long                                      bSentText : 1;                                            // 0x00E8(0x0004)
	unsigned long                                      bSentResponse : 1;                                        // 0x00E8(0x0004)
...
public:
	...
	struct FString                                     Applications[0xA];                                        // 0x02E8(0x0010) (Config, NeedCtorLink)
	struct FString                                     ApplicationPaths[0xA];                                    // 0x0388(0x0010) (Config, NeedCtorLink)
	unsigned long                                      bEnabled : 1;                                             // 0x0428(0x0004) (Config)
	...
	class UWebApplication*                             ApplicationObjects[0xA];                                  // 0x0450(0x0008)
...
public:
	...
	struct FScriptDelegate                             __OnDownloadChallengeFileComplete__Delegate;              // 0x00A0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x8];                                       // 0x00A0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnAcceptChallengeComplete__Delegate;                    // 0x00B8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x8];                                       // 0x00B8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnQueryChallengeUserStatusComplete__Delegate;           // 0x00D0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData03[0x8];                                       // 0x00D0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnUpdateChallengeUserProgressComplete__Delegate;        // 0x00E8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData04[0x8];                                       // 0x00E8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnUpdateChallengeUserRewardComplete__Delegate;          // 0x0100(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData05[0x8];                                       // 0x0100(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	TScriptInterface<class UOnlineTitleFileCacheInterface> FileCache;                                                // 0x0250(0x0010)
...
public:
	...
	struct FScriptDelegate                             __OnDeleteGroupComplete__Delegate;                        // 0x00B0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x8];                                       // 0x00B0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnQueryGroupsComplete__Delegate;                        // 0x00C8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x8];                                       // 0x00C8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnQueryGroupMembersComplete__Delegate;                  // 0x00E0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData03[0x8];                                       // 0x00E0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnAddGroupMembersComplete__Delegate;                    // 0x00F8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData04[0x8];                                       // 0x00F8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnRemoveGroupMembersComplete__Delegate;                 // 0x0110(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData05[0x8];                                       // 0x0110(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnDeleteAllGroupsComplete__Delegate;                    // 0x0128(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData06[0x8];                                       // 0x0128(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnQueryGroupInvitesComplete__Delegate;                  // 0x0140(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData07[0x8];                                       // 0x0140(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnAcceptGroupInviteComplete__Delegate;                  // 0x0158(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData08[0x8];                                       // 0x0158(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	struct FScriptDelegate                             __OnQueryGroupsRequestComplete__Delegate;                 // 0x0200(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0200(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnQueryGroupMembersRequestComplete__Delegate;           // 0x0218(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0218(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnAddGroupMembersRequestComplete__Delegate;             // 0x0230(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x8];                                       // 0x0230(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnAcceptGroupInviteRequestComplete__Delegate;           // 0x0248(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData03[0x8];                                       // 0x0248(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData00[0x8];                                       // 0x0088(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnQueryMappingsComplete__Delegate;                      // 0x00A0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x8];                                       // 0x00A0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData00[0x8];                                       // 0x0088(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnReadSaveSlotComplete__Delegate;                       // 0x00A0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x8];                                       // 0x00A0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnUpdateValueComplete__Delegate;                        // 0x00B8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x8];                                       // 0x00B8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnDeleteValueComplete__Delegate;                        // 0x00D0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData03[0x8];                                       // 0x00D0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	struct FScriptDelegate                             __OnCreateSaveSlotComplete__Delegate;                     // 0x0088(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0088(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnDeleteSaveSlotComplete__Delegate;                     // 0x00A0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x8];                                       // 0x00A0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnQuerySaveSlotListComplete__Delegate;                  // 0x00B8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x8];                                       // 0x00B8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnQueryInventoryItemsComplete__Delegate;                // 0x00D0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData03[0x8];                                       // 0x00D0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnPurchaseItemComplete__Delegate;                       // 0x00E8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData04[0x8];                                       // 0x00E8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnSellItemComplete__Delegate;                           // 0x0100(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData05[0x8];                                       // 0x0100(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnEarnItemComplete__Delegate;                           // 0x0118(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData06[0x8];                                       // 0x0118(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnConsumeItemComplete__Delegate;                        // 0x0130(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData07[0x8];                                       // 0x0130(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnDeleteItemComplete__Delegate;                         // 0x0148(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData08[0x8];                                       // 0x0148(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnRecordIapComplete__Delegate;                          // 0x0160(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData09[0x8];                                       // 0x0160(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData00[0x8];                                       // 0x0088(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnAuthenticateUserComplete__Delegate;                   // 0x00A0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x8];                                       // 0x00A0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnQueryUsersComplete__Delegate;                         // 0x00B8(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData02[0x8];                                       // 0x00B8(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FScriptDelegate                             __OnDeleteUserComplete__Delegate;                         // 0x00D0(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData03[0x8];                                       // 0x00D0(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	unsigned long                                      bDelayCleanup : 1;                                        // 0x0308(0x0004)
