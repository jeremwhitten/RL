...
struct FRigidBodyContactInfo
{
	...
	class UPhysicalMaterial*                           PhysMaterial[0x2];                                        // 0x0038(0x0008)
};
...
struct FTimerData
{
	...
	unsigned long                                      bStateTimer : 1;                                          // 0x0000(0x0004)
...
struct FPostProcessSettings
{
	...
	unsigned long                                      UnknownData00 : 32;                                       // 0x0000(0x0001)
	...
	struct FMobilePostProcessSettings                  MobilePostProcess;                                        // 0x0134(0x0034) (Edit)
};
...
struct FHostMigrationState
{
	...
	unsigned long                                      bHostMigrationEnabled : 1;                                // 0x0020(0x0004)
};
...
struct FXboxOneDLCInfo
{
	struct FString                                     Key;                                                      // 0x0000(0x0010) (NeedCtorLink)
	struct FName                                       Value;                                                    // 0x0010(0x0008)
	unsigned long                                      bDiscUnlock : 1;                                          // 0x0018(0x0004)
};
...
{
	struct FUniqueNetId                                PlayerNetId;                                              // 0x0000(0x0038) (Const)
};
...
{
	unsigned char                                      UnknownData00[0x8];                                       // 0x0038(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.OnlineArbitrationRegistrant.MachineId
	int                                                Trustworthiness;                                          // 0x0040(0x0004) (Const)
};
...
{
	TArray<unsigned char>                              EncryptionKey;                                            // 0x0000(0x0010) (NeedCtorLink)
	TArray<unsigned char>                              InitializationVector;                                     // 0x0010(0x0010) (NeedCtorLink)
	TArray<unsigned char>                              HMACKey;                                                  // 0x0020(0x0010) (NeedCtorLink)
	TArray<unsigned char>                              SessionIdentifier;                                        // 0x0030(0x0010) (NeedCtorLink)
	struct FUniqueNetId                                PlayerID;                                                 // 0x0040(0x0038)
...
struct FKAggregateGeom
{
	...
	unsigned long                                      bSimpleCollisionPlane : 1;                                // 0x0048(0x0004) (Edit)
};
...
struct FCoverSlot
{
	...
	unsigned long                                      bPreferLeanOverPopup : 1;                                 // 0x0090(0x0004) (Edit)
	unsigned long                                      bDestructible : 1;                                        // 0x0090(0x0004) (Transient)
	unsigned long                                      bSelected : 1;                                            // 0x0090(0x0004) (Transient)
	unsigned long                                      bFailedToFindSurface : 1;                                 // 0x0090(0x0004) (Edit, Transient, EditConst)
};
...
{
	struct FScriptDelegate                             Condition;                                                // 0x0000(0x0010) (Edit, NeedCtorLink)
...
struct FRBCollisionChannelContainer
{
	...
	unsigned long                                      Ball : 1;                                                 // 0x0000(0x0004) (Edit, Const)
	unsigned long                                      VehicleBlocker : 1;                                       // 0x0000(0x0004) (Edit, Const)
	unsigned long                                      BallBlocker : 1;                                          // 0x0000(0x0004) (Edit, Const)
...
{
	TEnumAsByte<EBankLoadStatus>                       Status;                                                   // 0x0000(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
...
struct FSettingsProperty
{
	...
	TEnumAsByte<EOnlineDataAdvertisementType>          AdvertisementType;                                        // 0x0018(0x0001)
};
...
struct FSettingsPropertyPropertyMetaData
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	struct FString                                     ColumnHeaderText;                                         // 0x0010(0x0010) (Const, Localized, NeedCtorLink)
	TEnumAsByte<EPropertyValueMappingType>             MappingType;                                              // 0x0020(0x0001) (Const)
...
struct FConnectedPeerInfo
{
	...
	unsigned long                                      bLostConnectionToHost : 1;                                // 0x003C(0x0004)
};
...
struct FDateTimeStruct
{
	...
	TEnumAsByte<ETimeZone>                             TimeZone;                                                 // 0x001C(0x0001) (DataBinding)
};
...
struct FFontImportOptionsData
{
	...
	unsigned long                                      bCreatePrintableOnly : 1;                                 // 0x0060(0x0004) (Edit)
	unsigned long                                      bIncludeASCIIRange : 1;                                   // 0x0060(0x0004) (Edit)
	struct FLinearColor                                ForegroundColor;                                          // 0x0064(0x0010) (Edit)
	unsigned long                                      bEnableDropShadow : 1;                                    // 0x0074(0x0004) (Edit)
	...
	unsigned long                                      bEnableLegacyMode : 1;                                    // 0x0098(0x0004) (Edit)
	int                                                Kerning;                                                  // 0x009C(0x0004) (Edit)
	unsigned long                                      bUseDistanceFieldAlpha : 1;                               // 0x00A0(0x0004) (Edit)
...
struct FGameSessionInformation
{
	...
	struct FUniqueNetId                                OwningNetId;                                              // 0x0080(0x0038) (Const)
	int                                                PlaylistId;                                               // 0x00B8(0x0004)
};
...
struct FPlayerInformation
{
	...
	struct FUniqueNetId                                UniqueId;                                                 // 0x0018(0x0038)
	unsigned long                                      bIsBot : 1;                                               // 0x0050(0x0004)
};
...
struct FBaseAuthSession
{
	...
	struct FUniqueNetId                                EndPointUID;                                              // 0x0018(0x0038) (Const)
};
...
{
	int                                                SessionUID;                                               // 0x0050(0x0004) (Const)
};
...
{
	TEnumAsByte<EAuthStatus>                           AuthStatus;                                               // 0x0050(0x0001) (Const)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0051(0x0003) MISSED OFFSET
	int                                                AuthTicketUID;                                            // 0x0054(0x0004) (Const)
};
...
{
	struct FUniqueNetId                                PlayerID;                                                 // 0x0000(0x0038) (Const)
	struct FSettingsData                               Rank;                                                     // 0x0038(0x0010) (Const)
	struct FString                                     Nickname;                                                 // 0x0048(0x0010) (Const, NeedCtorLink)
	TArray<struct FOnlineStatsColumn>                  Columns;                                                  // 0x0058(0x0010) (NeedCtorLink)
	TArray<struct FSettingsData>                       StatValues;                                               // 0x0068(0x0010) (NeedCtorLink)
};
...
{
	unsigned long                                      bClearColorTargetEveryFrame : 1;                          // 0x0000(0x0004) (Edit)
	struct FColor                                      ColorTargetClearColor;                                    // 0x0004(0x0004) (Edit)
	unsigned long                                      bClearDataTargetEveryFrame : 1;                           // 0x0008(0x0004) (Edit)
...
{
	unsigned long                                      bDrawColorDecal : 1;                                      // 0x0000(0x0004) (Edit)
	float                                              ColorTextureScale;                                        // 0x0004(0x0004) (Edit)
	class UTexture2D*                                  ColorTexture;                                             // 0x0008(0x0008) (Edit)
	unsigned long                                      bDrawDataDecal : 1;                                       // 0x0010(0x0004) (Edit)
...
struct FPostProcessSettingsOverride
{
	...
	unsigned long                                      bBlendingIn : 1;                                          // 0x0168(0x0004)
	unsigned long                                      bBlendingOut : 1;                                         // 0x0168(0x0004)
...
struct FGamepadInfo
{
	TEnumAsByte<EInputAPI>                             InputAPI;                                                 // 0x0000(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
	unsigned long                                      bConnected : 1;                                           // 0x0004(0x0004)
};
...
struct FAnimNotifyEvent
{
	...
	struct FName                                       Comment;                                                  // 0x0010(0x0008) (Edit)
...
{
	unsigned long                                      UseConstant : 1;                                          // 0x0038(0x0004)
...
struct AFracturedStaticMeshActor_FCheckpointRecord
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	TArray<unsigned char>                              FragmentVis;                                              // 0x0008(0x0010) (NeedCtorLink)
};
...
struct FCustomInput
{
	...
	struct FExpressionInput                            Input;                                                    // 0x0010(0x0038) (NeedCtorLink)
};
...
struct FLayerBlendInput
{
	...
	struct FExpressionInput                            LayerInput;                                               // 0x0010(0x0038) (NeedCtorLink)
	struct FExpressionInput                            HeightInput;                                              // 0x0048(0x0038) (NeedCtorLink)
...
struct FCurveParameterPoint
{
	...
	TEnumAsByte<EInterpCurveMode>                      InterpMode;                                               // 0x0030(0x0001) (Edit)
};
...
struct FSeqOpOutputLink
{
	...
	unsigned long                                      bMoving : 1;                                              // 0x0038(0x0004) (Transient)
	unsigned long                                      bClampedMax : 1;                                          // 0x0038(0x0004)
	unsigned long                                      bClampedMin : 1;                                          // 0x0038(0x0004)
	int                                                OverrideDelta;                                            // 0x003C(0x0004)
	float                                              PIEActivationTime;                                        // 0x0040(0x0004) (Transient)
	unsigned long                                      bIsActivated : 1;                                         // 0x0044(0x0004) (Transient, NoImport)
};
...
{
	struct FUniqueNetId                                SendingPlayerId;                                          // 0x0000(0x0038)
	struct FString                                     SendingPlayerNick;                                        // 0x0038(0x0010) (NeedCtorLink)
	unsigned long                                      bIsFriendInvite : 1;                                      // 0x0048(0x0004)
	unsigned long                                      bIsGameInvite : 1;                                        // 0x0048(0x0004)
	unsigned long                                      bWasAccepted : 1;                                         // 0x0048(0x0004)
	unsigned long                                      bWasDenied : 1;                                           // 0x0048(0x0004)
	unsigned char                                      UnknownData00[0x4];                                       // 0x004C(0x0004) MISSED OFFSET
	struct FString                                     Message;                                                  // 0x0050(0x0010) (NeedCtorLink)
};
...
{
	struct FUniqueNetId                                PlayerID;                                                 // 0x0000(0x0038)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0038(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.OnlineFriend.SessionId
	struct FString                                     PlayerName;                                               // 0x0040(0x0010) (NeedCtorLink)
	struct FString                                     PresenceInfo;                                             // 0x0050(0x0010) (NeedCtorLink)
	TEnumAsByte<EOnlineFriendState>                    FriendState;                                              // 0x0060(0x0001)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0061(0x0003) MISSED OFFSET
	unsigned long                                      bIsOnline : 1;                                            // 0x0064(0x0004)
	unsigned long                                      bIsPlaying : 1;                                           // 0x0064(0x0004)
	unsigned long                                      bIsPlayingThisGame : 1;                                   // 0x0064(0x0004)
	unsigned long                                      bIsJoinable : 1;                                          // 0x0064(0x0004)
	unsigned long                                      bHasVoiceSupport : 1;                                     // 0x0064(0x0004)
	unsigned long                                      bHaveInvited : 1;                                         // 0x0064(0x0004)
	unsigned long                                      bHasInvitedYou : 1;                                       // 0x0064(0x0004)
	int                                                GroupId;                                                  // 0x0068(0x0004) (Const)
...
{
	struct FUniqueNetId                                UniqueId;                                                 // 0x0000(0x0038) (Const)
	struct FString                                     Nickname;                                                 // 0x0038(0x0010) (Const, NeedCtorLink)
	unsigned char                                      LocalUserNum;                                             // 0x0048(0x0001) (Const)
	TEnumAsByte<ENATType>                              NatType;                                                  // 0x0049(0x0001) (Const)
	unsigned char                                      UnknownData00[0x2];                                       // 0x004A(0x0002) MISSED OFFSET
	int                                                TitleId;                                                  // 0x004C(0x0004) (Const)
	unsigned long                                      bIsLocal : 1;                                             // 0x0050(0x0004) (Const)
	unsigned long                                      bIsInPartyVoice : 1;                                      // 0x0050(0x0004) (Const)
	unsigned long                                      bIsTalking : 1;                                           // 0x0050(0x0004) (Const)
	unsigned long                                      bIsInGameSession : 1;                                     // 0x0050(0x0004) (Const)
	unsigned long                                      bIsPlayingThisGame : 1;                                   // 0x0050(0x0004) (Const)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0054(0x0004) MISSED OFFSET
	unsigned char                                      UnknownData02[0x8];                                       // 0x0054(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.OnlinePartyMember.SessionId
	int                                                Data1;                                                    // 0x0060(0x0004) (Const)
	int                                                Data2;                                                    // 0x0064(0x0004) (Const)
	int                                                Data3;                                                    // 0x0068(0x0004) (Const)
	int                                                Data4;                                                    // 0x006C(0x0004) (Const)
};
...
struct FAchievementDetails
{
	...
	unsigned long                                      bIsSecret : 1;                                            // 0x0058(0x0004) (Const)
	unsigned long                                      bWasAchievedOnline : 1;                                   // 0x0058(0x0004) (Const)
	unsigned long                                      bWasAchievedOffline : 1;                                  // 0x0058(0x0004) (Const)
	TEnumAsByte<EAchievementUnlockType>                UnlockType;                                               // 0x005C(0x0001) (Const)
	unsigned char                                      UnknownData01[0x3];                                       // 0x005D(0x0003) MISSED OFFSET
	unsigned char                                      UnknownData02[0x8];                                       // 0x005D(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.AchievementDetails.ChallengeWindowBegin
	unsigned char                                      UnknownData03[0x8];                                       // 0x0068(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.AchievementDetails.ChallengeWindowEnd
	struct FString                                     DeepLink;                                                 // 0x0070(0x0010) (Const, NeedCtorLink)
	unsigned char                                      UnknownData04[0x8];                                       // 0x0080(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.AchievementDetails.EstimatedUnlockTime
	unsigned long                                      bIsRevoked : 1;                                           // 0x0088(0x0004) (Const)
	TEnumAsByte<EAchievementParticipationType>         ParticipationType;                                        // 0x008C(0x0001) (Const)
	...
	TEnumAsByte<EAchievementProgressState>             ProgressState;                                            // 0x00A0(0x0001) (Const)
...
struct FUIDataStoreInputAlias
{
	...
	struct FUIInputKeyData                             PlatformInputKeys[0x7];                                   // 0x0008(0x0020) (Config, NeedCtorLink)
};
...
struct FLensFlareElement
{
	...
	unsigned long                                      bOrientTowardsSource : 1;                                 // 0x00D0(0x0004) (Edit)
...
struct FBuildingMeshInfo
{
	...
	unsigned long                                      bMeshScaleTranslation : 1;                                // 0x0028(0x0004) (Edit)
	unsigned long                                      bOverrideMeshLightMapRes : 1;                             // 0x0028(0x0004) (Edit)
...
struct FCameraShakeInstance
{
	...
	TEnumAsByte<ECameraAnimPlaySpace>                  PlaySpace;                                                // 0x0050(0x0001)
...
struct FFriendsQuery
{
	...
	unsigned long                                      bIsFriend : 1;                                            // 0x0038(0x0004)
};
...
struct FDownloadedWorkshopData
{
	...
	struct FUniqueNetId                                AuthorNetID;                                              // 0x0028(0x0038)
	class UTexture2DDynamic*                           Preview;                                                  // 0x0060(0x0008) (DataBinding)
	class UTexture*                                    Avatar;                                                   // 0x0068(0x0008) (DataBinding)
	struct FString                                     Description;                                              // 0x0070(0x0010) (NeedCtorLink, DataBinding)
	struct FString                                     PreviewURL;                                               // 0x0080(0x0010) (NeedCtorLink, DataBinding)
	struct FString                                     ItemPath;                                                 // 0x0090(0x0010) (NeedCtorLink, DataBinding)
	struct FString                                     Filename;                                                 // 0x00A0(0x0010) (NeedCtorLink, DataBinding)
	struct FString                                     FullPath;                                                 // 0x00B0(0x0010) (NeedCtorLink, DataBinding)
};
...
struct FCommunityContentFile
{
	...
	struct FUniqueNetId                                Owner;                                                    // 0x0028(0x0038)
	int                                                DownloadCount;                                            // 0x0060(0x0004)
	float                                              AverageRating;                                            // 0x0064(0x0004)
	int                                                RatingCount;                                              // 0x0068(0x0004)
	int                                                LastRatingGiven;                                          // 0x006C(0x0004)
	struct FString                                     LocalFilePath;                                            // 0x0070(0x0010) (NeedCtorLink)
};
...
struct FLobbyMember
{
	...
	TArray<struct FLobbyMetaData>                      PlayerSettings;                                           // 0x0038(0x0010) (NeedCtorLink)
	struct FString                                     OnlineName;                                               // 0x0048(0x0010) (NeedCtorLink)
};
...
struct FLobbyFilter
{
	struct FString                                     Key;                                                      // 0x0000(0x0010) (NeedCtorLink)
	struct FString                                     Value;                                                    // 0x0010(0x0010) (NeedCtorLink)
	TEnumAsByte<EOnlineGameSearchComparisonType>       Operator;                                                 // 0x0020(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0021(0x0003) MISSED OFFSET
	unsigned long                                      bNumeric : 1;                                             // 0x0024(0x0004)
};
...
struct FMarketplaceInventoryItem
{
	...
	unsigned char                                      UnknownData02[0x8];                                       // 0x0030(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.MarketplaceInventoryItem.StartDate
	unsigned char                                      UnknownData03[0x8];                                       // 0x0038(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.MarketplaceInventoryItem.EndDate
	unsigned char                                      UnknownData04[0x8];                                       // 0x0040(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.MarketplaceInventoryItem.RightsObtainedDate
...
struct FMarketplaceProductAvailability
{
	...
	unsigned long                                      bIsPurchasable : 1;                                       // 0x0070(0x0004) (Const)
...
struct FMarketplaceProductDetails
{
	...
	unsigned char                                      UnknownData01[0x8];                                       // 0x0038(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.MarketplaceProductDetails.ReleaseDate
	...
	TEnumAsByte<EOnlineEnumerationReadState>           DetailsReadState;                                         // 0x0068(0x0001)
...
struct FSessionMemberInfo
{
	...
	TEnumAsByte<ESessionMemberStatus>                  MemberStatus;                                             // 0x0038(0x0001)
};
...
{
	struct FUniqueNetId                                TalkerId;                                                 // 0x0000(0x0038)
	float                                              LastNotificationTime;                                     // 0x0038(0x0004)
	unsigned long                                      bWasTalking : 1;                                          // 0x003C(0x0004)
	unsigned long                                      bIsTalking : 1;                                           // 0x003C(0x0004)
	unsigned long                                      bIsRegistered : 1;                                        // 0x003C(0x0004)
};
...
{
	struct FUniqueNetId                                TalkerId;                                                 // 0x0000(0x0038)
	unsigned long                                      bHasVoice : 1;                                            // 0x0038(0x0004)
	unsigned long                                      bHasNetworkedVoice : 1;                                   // 0x0038(0x0004)
	unsigned long                                      bIsRecognizingSpeech : 1;                                 // 0x0038(0x0004)
	unsigned long                                      bWasTalking : 1;                                          // 0x0038(0x0004)
	unsigned long                                      bIsTalking : 1;                                           // 0x0038(0x0004)
	unsigned long                                      bIsRegistered : 1;                                        // 0x0038(0x0004)
};
...
struct FNavMeshPathGoalEvaluatorCacheDatum
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	class UNavMeshPathGoalEvaluator*                   List[0x5];                                                // 0x0008(0x0008)
};
...
struct FNavMeshPathConstraintCacheDatum
{
	int                                                ListIdx;                                                  // 0x0000(0x0004)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	class UNavMeshPathConstraint*                      List[0x5];                                                // 0x0008(0x0008)
};
...
struct FRecentParty
{
	...
	TArray<struct FUniqueNetId>                        PartyMembers;                                             // 0x0038(0x0010) (NeedCtorLink)
};
