...
struct FOnlineImageDownload
{
	...
	struct FScriptDelegate                             DecodedCallbacks;                                         // 0x0028(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0028(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
};
...
struct FDecodeImageRequest
{
	...
	struct FScriptDelegate                             OnFinishedCallback;                                       // 0x0010(0x0010) (NeedCtorLink)
...
struct FEventUploadConfig
{
	...
	unsigned long                                      bUseCompression : 1;                                      // 0x001C(0x0004) (Const)
};
...
struct FNewsCacheEntry
{
	...
	unsigned long                                      bIsUnicode : 1;                                           // 0x002C(0x0004) (Const)
...
struct FClientConnectionRequest
{
	...
	unsigned long                                      bCanHostVs : 1;                                           // 0x003C(0x0004)
...
struct FClientMeshBeaconConnection
{
	...
	unsigned long                                      bConnectionAccepted : 1;                                  // 0x0048(0x0004)
	...
	unsigned long                                      bCanHostVs : 1;                                           // 0x0084(0x0004)
...
struct FPlaylist
{
	...
	unsigned long                                      bDisableDedicatedServerSearches : 1;                      // 0x006C(0x0004)
...
struct FMcpClashMobChallengeUserStatus
{
	...
	unsigned long                                      did_preregister : 1;                                      // 0x0058(0x0004)
	unsigned char                                      UnknownData01[0x4];                                       // 0x005C(0x0004) MISSED OFFSET
	struct FString                                     facebook_like_time;                                       // 0x0060(0x0010) (NeedCtorLink)
	unsigned long                                      enrolled_via_facebook : 1;                                // 0x0070(0x0004)
	unsigned long                                      liked_via_facebook : 1;                                   // 0x0070(0x0004)
	unsigned long                                      commented_via_facebook : 1;                               // 0x0070(0x0004)
	...
	unsigned long                                      enrolled_via_twitter : 1;                                 // 0x0088(0x0004)
	unsigned long                                      retweeted : 1;                                            // 0x0088(0x0004)
};
