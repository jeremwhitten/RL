...
public:
	...
	unsigned long                                      bFakeMobileTouches : 1;                                   // 0x00D8(0x0004)
...
public:
	...
	unsigned long                                      bMovieIsOpen : 1;                                         // 0x0128(0x0004) (Const)
	unsigned long                                      bDisplayWithHudOff : 1;                                   // 0x0128(0x0004)
	unsigned long                                      bEnableGammaCorrection : 1;                               // 0x0128(0x0004)
	unsigned long                                      bWidgetsInitializedThisFrame : 1;                         // 0x0128(0x0004) (Const, Transient)
	unsigned long                                      bLogUnhandedWidgetInitializations : 1;                    // 0x0128(0x0004)
	unsigned long                                      bAllowInput : 1;                                          // 0x0128(0x0004)
	unsigned long                                      bAllowFocus : 1;                                          // 0x0128(0x0004)
	unsigned long                                      bAutoPlay : 1;                                            // 0x0128(0x0004)
	unsigned long                                      bPauseGameWhileActive : 1;                                // 0x0128(0x0004)
	unsigned long                                      bDisableWorldRendering : 1;                               // 0x0128(0x0004)
	unsigned long                                      bCaptureWorldRendering : 1;                               // 0x0128(0x0004)
	unsigned long                                      bCloseOnLevelChange : 1;                                  // 0x0128(0x0004)
	unsigned long                                      bOnlyOwnerFocusable : 1;                                  // 0x0128(0x0004)
	unsigned long                                      bForceFullViewport : 1;                                   // 0x0128(0x0004)
	unsigned long                                      bDiscardNonOwnerInput : 1;                                // 0x0128(0x0004)
	unsigned long                                      bCaptureInput : 1;                                        // 0x0128(0x0004)
	unsigned long                                      bCaptureMouseInput : 1;                                   // 0x0128(0x0004)
	unsigned long                                      bIgnoreMouseInput : 1;                                    // 0x0128(0x0004)
	unsigned long                                      bIsSplitscreenLayoutModified : 1;                         // 0x0128(0x0004) (Transient)
	unsigned long                                      bShowHardwareMouseCursor : 1;                             // 0x0128(0x0004)
	unsigned long                                      bForceFullScreen : 1;                                     // 0x0128(0x0004)
	unsigned long                                      bBlurLesserMovies : 1;                                    // 0x0128(0x0004)
	unsigned long                                      bHideLesserMovies : 1;                                    // 0x0128(0x0004)
	unsigned long                                      bIsPriorityBlurred : 1;                                   // 0x0128(0x0004)
	unsigned long                                      bIsPriorityHidden : 1;                                    // 0x0128(0x0004)
	unsigned long                                      bIgnoreVisibilityEffect : 1;                              // 0x0128(0x0004)
	unsigned long                                      bIgnoreBlurEffect : 1;                                    // 0x0128(0x0004)
	...
	TEnumAsByte<EGFxTimingMode>                        TimingMode;                                               // 0x0188(0x0001)
	TEnumAsByte<EGFxRenderTextureMode>                 RenderTextureMode;                                        // 0x0189(0x0001)
	unsigned char                                      Priority;                                                 // 0x018A(0x0001)
	unsigned char                                      UnknownData05[0x5];                                       // 0x018B(0x0005) MISSED OFFSET
	TArray<struct FGFxWidgetBinding>                   WidgetBindings;                                           // 0x0190(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData06[0x50];                                      // 0x01A0(0x0050) UNKNOWN PROPERTY: MapProperty GFxUI.GFxMoviePlayer.WidgetPathBindings
	...
	struct FScriptDelegate                             __OnPostAdvance__Delegate;                                // 0x0200(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownData08[0x8];                                       // 0x01FC(0x0008) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	TEnumAsByte<EFlashTextureRescale>                  TextureRescale;                                           // 0x00BC(0x0001) (Edit)
	...
	TArray<TEnumAsByte<EEdition>>                      Editions;                                                 // 0x00E8(0x0010) (Edit, NeedCtorLink)
	...
	unsigned char                                      UnknownData03[0x8];                                       // 0x0110(0x0008) UNKNOWN PROPERTY: QWordProperty GFxUI.SwfMovie.ImportTimeStamp
...
public:
	...
	unsigned long                                      bUnload : 1;                                              // 0x0168(0x0004) (Edit)
...
public:
	...
	unsigned long                                      bTakeFocus : 1;                                           // 0x0178(0x0004) (Edit)
	unsigned long                                      bCaptureInput : 1;                                        // 0x0178(0x0004) (Edit)
	unsigned long                                      bStartPaused : 1;                                         // 0x0178(0x0004) (Edit)
	unsigned long                                      bEnableGammaCorrection : 1;                               // 0x0178(0x0004)
	unsigned long                                      bDisplayWithHudOff : 1;                                   // 0x0178(0x0004) (Edit)
	TEnumAsByte<EGFxRenderTextureMode>                 RenderTextureMode;                                        // 0x017C(0x0001) (Edit)
